...
class CommentsViewSet(mixins.CreateModelMixin,
    ...
    def get_queryset(self, export=False):
        ...
        return get_queryset_filter(entity_name, object_id, username, start_date, end_date, export)
    ...
    def csv_export(self, request):
        ...
        return export_to_csv(exporting_queryset)
